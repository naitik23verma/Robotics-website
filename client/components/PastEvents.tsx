          ...
          <div className="bg-white rounded-lg p-6 w-80">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-gray-600 font-poppins">Total Participants</span>
                <span className="text-gray-800 font-poppins font-bold">500+</span>
              </div>
              
              <div className="flex justify-between items-center">
                <span className="text-gray-600 font-poppins">Events Organized</span>
                <span className="text-gray-800 font-poppins font-bold">25+</span>
              </div>
              
              <div className="flex justify-between items-center">
                <span className="text-gray-600 font-poppins">Prizes Won</span>
                <span className="text-gray-800 font-poppins font-bold">15+</span>
              </div>
              
              <div className="flex justify-between items-center">
                <span className="text-gray-600 font-poppins">Active Members</span>
                <span className="text-gray-800 font-poppins font-bold">80+</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-16">
          <div className="bg-white rounded-lg p-6">
            ...
            <p className="text-gray-600 font-poppins text-base mb-4">
              "The robotics club helped me develop practical skills that I use in my career today. Amazing experience!"
            </p>
          ...
          <div className="bg-white rounded-lg p-6">
            ...
            <p className="text-gray-600 font-poppins text-base mb-4">
              "Best platform to learn robotics and automation. The mentorship is excellent."
            </p>
