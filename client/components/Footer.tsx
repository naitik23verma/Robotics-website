    ...
    <footer className="bg-[#0F1A35] border-2 border-white border-opacity-70 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-20 py-12">
        ...
        <div className="grid lg:grid-cols-4 gap-8 mb-16">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-6 mb-6">
              <div className="w-48 h-50 bg-gray-300 rounded-full flex items-center justify-center">
                <span className="text-black text-opacity-33 font-inter text-5xl">Logo</span>
              </div>
            </div>
          </div>
          ...
          {/* Navigation */}
          <div>
            <h3 className="text-white font-poppins text-lg font-bold mb-5">Navigation</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-white font-poppins text-base hover:text-robotics-green transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/robomax" className="text-white font-poppins text-base hover:text-robotics-green transition-colors">
                  RoboMAX
                </Link>
              </li>
              <li>
                <Link to="/team" className="text-white font-poppins text-base hover:text-robotics-green transition-colors">
                  Our Team
                </Link>
              </li>
              <li>
                <Link to="/events" className="text-white font-poppins text-base hover:text-robotics-green transition-colors">
                  Past Events
                </Link>
              </li>
            </ul>
          ...
          {/* Social Media */}
          <div>
            <h3 className="text-white font-poppins text-lg font-bold mb-5">Follow Us</h3>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 22 24">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-white font-poppins text-lg font-bold mb-5">Contact Info</h3>
            <div className="space-y-2">
              <p className="text-white font-poppins text-base">Phone: +91 12345 67890</p>
              <p className="text-white font-poppins text-base">Email: robotics@manit.ac.in</p>
              <p className="text-white font-poppins text-base">Room: Tech Block, MANIT</p>
            </div>
          </div>
        </div>
